...
-- All six real accounts (docs/MANUAL_SETUP.md). Re-running this file is safe: `on conflict (email)
-- do update` lets a reassignment (e.g. changing who owns which brand) just mean editing this file
-- and re-applying it.
...
values
  ...
  ('hamedfaisalkamel@gmail.com',   (select id from public.brands where slug = 'marrakech'), 'analyst')
